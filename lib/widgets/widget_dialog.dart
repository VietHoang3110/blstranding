...
class WidgetDialog extends StatelessWidget {
  ...
  const WidgetDialog({
    ...
    this.textColorButton1 = AppColors.white,
    this.textColorButton2 = AppColors.black,
    this.backgroundButton1 = AppColors.primaryColor,
    this.backgroundButton2 = AppColors.white,
