...
class SetCommandBuySellOwn extends StatefulWidget {
  const SetCommandBuySellOwn({
    Key? key,
  }) : super(key: key);

  @override
  State<SetCommandBuySellOwn> createState() => _SetCommandBuySellOwnState();
}

class _SetCommandBuySellOwnState extends State<SetCommandBuySellOwn> {
