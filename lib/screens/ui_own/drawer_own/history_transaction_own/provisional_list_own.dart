...
import 'package:quan_ly/bloc/unrealized_own/unrealized_own_bloc.dart';
...
class ProvisionalListOwn extends StatefulWidget {
  const ProvisionalListOwn({Key? key}) : super(key: key);

  @override
  State<ProvisionalListOwn> createState() => _ProvisionalListOwnState();
}

class _ProvisionalListOwnState extends State<ProvisionalListOwn> {

  @override
  void initState() {
    UnrealizedOwnBloc.of(context).add(InitGetUnrealizedOwnEvent());
    super.initState();
  }
  int indexList = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<UnrealizedOwnBloc, UnrealizedOwnState>(
        builder: (context, state) {
          if(state is UpdateGetUnrealizedOwnState){
            return Container(
                                    ...
                                    Container(
                                      ...
                                      rows:  List.generate(state.data.dataTable!.length,
                                              ...
                                              cells: [
                                                ...
                                                DataCell(Text((state.data.dataTable![indexList].buyDate ?? '').toString())),
                                                ...
                                                DataCell(Align(alignment: Alignment.centerRight,
                                                    child: Text((state.data.dataTable![indexList].purchaseFee ?? '').toString()))),
